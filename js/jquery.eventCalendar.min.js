                ...
                $.each(data, function(key, event) {
                    ...
                    if (limit === 0 || limit > i) {
                        ...
                        if ((month === false || month == eventMonth) && (day == "" || day == eventDay) && (year == "" || year == eventYear)) {
                            if (month === false && eventDate < new Date()) {} else {
                                eventStringDate = eventDay + "/" + eventMonthToShow + "/" + eventYear;
                                events.push('<li id="' + key + '" class="' + event.type + '"><time datetime="' + eventDate + '"><em>' + eventStringDate + "</em><small>" + eventHour + ":" + eventMinute + '</small></time><a href="' + event.url + '" target="' + eventLinkTarget + '" class="eventTitle">' + event.title + '</a><p class="event_place">' + event.place + '</p><p class="eventDesc ' + eventDescClass + '">' + event.description + "</p></li>");
                                i++
                            }
                        }
                    }
